...
/*
  Copiado de web-sell/src/components/ui/sheet.tsx. Unico cambio: aqui no lleva
  el boton de cerrar en `absolute top-4 right-4`. El unico Sheet del panel es el
  rail sobre fondo negro, y ahi esa esquina la ocupa la marca; el cierre va
  dentro del propio rail, junto al logotipo.
*/
